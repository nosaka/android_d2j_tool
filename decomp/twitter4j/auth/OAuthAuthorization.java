...
_L7:
    ...
    String generateAuthorizationHeader(String s, String s1, HttpParameter ahttpparameter[], String s2, String s3, OAuthToken oauthtoken)
    {
        ...
        return (new StringBuilder()).append("OAuth ").append(encodeParameters(ahttpparameter, ",", true)).toString();
    }
    ...
    public List generateOAuthSignatureHttpParams(String s, String s1)
    {
        ...
        arraylist.add(new HttpParameter("oauth_nonce", l + l1));
...
_L3:
        ...
        throws TwitterException
    {
        ...
        if(s3.indexOf("http://") == 0)
            s2 = (new StringBuilder()).append("https://").append(s3.substring(7)).toString();
    ...
    public RequestToken getOAuthRequestToken(String s)
        throws TwitterException
    {
        return getOAuthRequestToken(s, null, null);
    }

    public RequestToken getOAuthRequestToken(String s, String s1)
        throws TwitterException
    {
        return getOAuthRequestToken(s, s1, null);
    }
        ...
        throws TwitterException
    {
        ...
        if(s2 != null)
            arraylist.add(new HttpParameter("x_auth_mode", s2));
    ...
    {
        return (new StringBuilder()).append("OAuthAuthorization{consumerKey='").append(consumerKey).append('\'').append(", consumerSecret='******************************************', oauthToken=").append(oauthToken).append('}').toString();
    }
    ...
    private static final long serialVersionUID = 0xfbef244cL;
