    ...
    implements Serializable
{
    ...
    public TimeSpanConverter(Locale locale)
    {
        ...
        if("es".equals(s))
        {
            ...
            formats[2] = new MessageFormat("hace 1 minuto");
            formats[3] = new MessageFormat("hace {0} minutos");
    ...
    public String toTimeSpanString(long l)
    {
    ...
    private static final long serialVersionUID = 0x89f3c16cL;
