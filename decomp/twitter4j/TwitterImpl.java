    ...
    implements Twitter
{
    ...
    TwitterImpl(Configuration configuration, Authorization authorization)
    {
        ...
        if(flag)
        {
            ...
            obj = (new StringBuilder()).append(((String) (obj))).append("contributingto=").append(configuration.getContributingTo()).toString();
        }
        authorization = new ArrayList(3);
        if(configuration.isIncludeEntitiesEnabled())
            authorization.add(new HttpParameter("include_entities", "true"));
        if(flag)
            authorization.add(new HttpParameter("contributingto", configuration.getContributingTo()));
        if(configuration.isTrimUserEnabled())
            authorization.add(new HttpParameter("trim_user", "1"));
        if(configuration.isIncludeExtAltTextEnabled())
            authorization.add(new HttpParameter("include_ext_alt_text", "true"));
        if(configuration.isTweetModeExtended())
            authorization.add(new HttpParameter("tweet_mode", "extended"));
        authorization = (HttpParameter[])authorization.toArray(new HttpParameter[authorization.size()]);
        implicitParamsStrMap.putIfAbsent(configuration, obj);
        implicitParamsMap.putIfAbsent(configuration, authorization);
        IMPLICIT_PARAMS = authorization;
        IMPLICIT_PARAMS_STR = ((String) (obj));
    }
    ...
    private transient HttpResponse get(String s, HttpParameter ahttpparameter[])
        throws TwitterException
    {
        long l;
        ensureAuthorizationEnabled();
    ...
    private transient HttpParameter[] mergeImplicitParams(HttpParameter ahttpparameter[])
    {
    ...
    private transient HttpResponse post(String s, HttpParameter ahttpparameter[])
        throws TwitterException
    {
        long l;
        ensureAuthorizationEnabled();
    ...
    public User createBlock(String s)
        throws TwitterException
    {
        return factory.createUser(post((new StringBuilder()).append(conf.getRestBaseURL()).append("blocks/create.json").toString(), new HttpParameter[] {
            new HttpParameter("screen_name", s)
        }));
    }
    ...
    public User createFriendship(String s)
        throws TwitterException
    {
        return factory.createUser(post((new StringBuilder()).append(conf.getRestBaseURL()).append("friendships/create.json").toString(), new HttpParameter[] {
            new HttpParameter("screen_name", s)
        }));
    }
    ...
    {
        return factory.createUser(post((new StringBuilder()).append(conf.getRestBaseURL()).append("friendships/create.json").toString(), new HttpParameter[] {
            new HttpParameter("screen_name", s), new HttpParameter("follow", flag)
        }));
    }
    ...
    public User createMute(String s)
        throws TwitterException
    {
        return factory.createUser(post((new StringBuilder()).append(conf.getRestBaseURL()).append("mutes/users/create.json").toString(), new HttpParameter[] {
            new HttpParameter("screen_name", s)
        }));
    }
    ...
    public transient UserList createUserListMembers(long l, String s, long al[])
        throws TwitterException
    {
    ...
    public transient UserList createUserListMembers(long l, String s, String as[])
        throws TwitterException
    {
        return factory.createAUserList(post((new StringBuilder()).append(conf.getRestBaseURL()).append("lists/members/create_all.json").toString(), new HttpParameter[] {
    ...
    public transient UserList createUserListMembers(long l, long al[])
        throws TwitterException
    {
        return factory.createAUserList(post((new StringBuilder()).append(conf.getRestBaseURL()).append("lists/members/create_all.json").toString(), new HttpParameter[] {
    ...
    public transient UserList createUserListMembers(long l, String as[])
        throws TwitterException
    {
        return factory.createAUserList(post((new StringBuilder()).append(conf.getRestBaseURL()).append("lists/members/create_all.json").toString(), new HttpParameter[] {
    ...
    public transient UserList createUserListMembers(String s, String s1, long al[])
        throws TwitterException
    {
        return factory.createAUserList(post((new StringBuilder()).append(conf.getRestBaseURL()).append("lists/members/create_all.json").toString(), new HttpParameter[] {
    ...
    public transient UserList createUserListMembers(String s, String s1, String as[])
        throws TwitterException
    {
        return factory.createAUserList(post((new StringBuilder()).append(conf.getRestBaseURL()).append("lists/members/create_all.json").toString(), new HttpParameter[] {
    ...
    public User destroyBlock(String s)
        throws TwitterException
    {
        return factory.createUser(post((new StringBuilder()).append(conf.getRestBaseURL()).append("blocks/destroy.json").toString(), new HttpParameter[] {
            new HttpParameter("screen_name", s)
        }));
    }
    ...
    public DirectMessage destroyDirectMessage(long l)
        throws TwitterException
    {
        return factory.createDirectMessage(post((new StringBuilder()).append(conf.getRestBaseURL()).append("direct_messages/destroy.json?id=").append(l).append("&full_text=true").toString()));
    }
    ...
    public User destroyFriendship(String s)
        throws TwitterException
    {
        return factory.createUser(post((new StringBuilder()).append(conf.getRestBaseURL()).append("friendships/destroy.json").toString(), new HttpParameter[] {
            new HttpParameter("screen_name", s)
        }));
    }
    ...
    public User destroyMute(String s)
        throws TwitterException
    {
        return factory.createUser(post((new StringBuilder()).append(conf.getRestBaseURL()).append("mutes/users/destroy.json").toString(), new HttpParameter[] {
            new HttpParameter("screen_name", s)
        }));
    }
    ...
    public SavedSearch destroySavedSearch(long l)
        throws TwitterException
    {
        return factory.createSavedSearch(post((new StringBuilder()).append(conf.getRestBaseURL()).append("saved_searches/destroy/").append(l).append(".json").toString()));
    }
    ...
    public ResponseList getContributees(String s)
        throws TwitterException
    {
        return factory.createUserList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("users/contributees.json").toString(), new HttpParameter[] {
            new HttpParameter("screen_name", s)
        }));
    }
    ...
    public ResponseList getContributors(String s)
        throws TwitterException
    {
        return factory.createUserList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("users/contributors.json").toString(), new HttpParameter[] {
            new HttpParameter("screen_name", s)
        }));
    }
    ...
    public ResponseList getDirectMessages()
        throws TwitterException
    {
        return factory.createDirectMessageList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("direct_messages.json?full_text=true").toString()));
    }

    public ResponseList getDirectMessages(Paging paging)
        throws TwitterException
    {
        return factory.createDirectMessageList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("direct_messages.json").toString(), mergeParameters(paging.asPostParameterArray(), new HttpParameter("full_text", true))));
    }
    ...
    public ResponseList getFavorites(String s)
        throws TwitterException
    {
        return factory.createStatusList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("favorites/list.json").toString(), new HttpParameter[] {
            new HttpParameter("screen_name", s)
        }));
    }
    ...
    public IDs getFollowersIDs(String s, long l)
        throws TwitterException
    {
        return factory.createIDs(get((new StringBuilder()).append(conf.getRestBaseURL()).append("followers/ids.json").toString(), new HttpParameter[] {
            new HttpParameter("screen_name", s), new HttpParameter("cursor", l)
        }));
    }
    ...
    {
        return factory.createIDs(get((new StringBuilder()).append(conf.getRestBaseURL()).append("followers/ids.json").toString(), new HttpParameter[] {
            new HttpParameter("screen_name", s), new HttpParameter("cursor", l), new HttpParameter("count", i)
        }));
    }
    ...
    public PagableResponseList getFollowersList(String s, long l, int i)
        throws TwitterException
    {
        return factory.createPagableUserList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("followers/list.json").toString(), new HttpParameter[] {
            new HttpParameter("screen_name", s), new HttpParameter("cursor", l), new HttpParameter("count", i)
        }));
    }
    ...
    {
        return factory.createPagableUserList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("followers/list.json").toString(), new HttpParameter[] {
            new HttpParameter("screen_name", s), new HttpParameter("cursor", l), new HttpParameter("count", i), new HttpParameter("skip_status", flag), new HttpParameter("include_user_entities", flag1)
        }));
    }
    ...
    public IDs getFriendsIDs(String s, long l)
        throws TwitterException
    {
        return factory.createIDs(get((new StringBuilder()).append(conf.getRestBaseURL()).append("friends/ids.json").toString(), new HttpParameter[] {
            new HttpParameter("screen_name", s), new HttpParameter("cursor", l)
        }));
    }
    ...
    public PagableResponseList getFriendsList(String s, long l, int i)
        throws TwitterException
    {
        return factory.createPagableUserList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("friends/list.json").toString(), new HttpParameter[] {
            new HttpParameter("screen_name", s), new HttpParameter("cursor", l), new HttpParameter("count", i)
        }));
    }
    ...
    public ResponseList getSentDirectMessages()
        throws TwitterException
    {
        return factory.createDirectMessageList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("direct_messages/sent.json?full_text=true").toString()));
    }

    public ResponseList getSentDirectMessages(Paging paging)
        throws TwitterException
    {
        return factory.createDirectMessageList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("direct_messages/sent.json").toString(), mergeParameters(paging.asPostParameterArray(), new HttpParameter("full_text", true))));
    }
    ...
    public PagableResponseList getUserListMembers(long l, int i, long l1)
        throws TwitterException
    {
        return getUserListMembers(l, i, l1, false);
    }

    public PagableResponseList getUserListMembers(long l, int i, long l1, boolean flag)
        throws TwitterException
    {
        return factory.createPagableUserList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("lists/members.json").toString(), new HttpParameter[] {
            new HttpParameter("list_id", l), new HttpParameter("count", i), new HttpParameter("cursor", l1), new HttpParameter("skip_status", flag)
        }));
    }
    ...
    public PagableResponseList getUserListMembers(long l, long l1)
        throws TwitterException
    {
        return getUserListMembers(l, 20, l1, false);
    }

    public PagableResponseList getUserListMembers(long l, String s, int i, long l1)
        throws TwitterException
    {
        return getUserListMembers(l, s, i, l1, false);
    }

    public PagableResponseList getUserListMembers(long l, String s, int i, long l1, boolean flag)
        throws TwitterException
    {
        return factory.createPagableUserList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("lists/members.json").toString(), new HttpParameter[] {
            new HttpParameter("owner_id", l), new HttpParameter("slug", s), new HttpParameter("count", i), new HttpParameter("cursor", l1), new HttpParameter("skip_status", flag)
        }));
    }
    ...
    public PagableResponseList getUserListMembers(long l, String s, long l1)
        throws TwitterException
    {
        return getUserListMembers(l, s, 20, l1, false);
    }

    public PagableResponseList getUserListMembers(String s, String s1, int i, long l)
        throws TwitterException
    {
        return getUserListMembers(s, s1, i, l, false);
    }

    public PagableResponseList getUserListMembers(String s, String s1, int i, long l, boolean flag)
        throws TwitterException
    {
        return factory.createPagableUserList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("lists/members.json").toString(), new HttpParameter[] {
            new HttpParameter("owner_screen_name", s), new HttpParameter("slug", s1), new HttpParameter("count", i), new HttpParameter("cursor", l), new HttpParameter("skip_status", flag)
        }));
    }
    ...
    public PagableResponseList getUserListMembers(String s, String s1, long l)
        throws TwitterException
    {
        return getUserListMembers(s, s1, 20, l, false);
    }

    public PagableResponseList getUserListMemberships(int i, long l)
        throws TwitterException
    {
        return factory.createPagableUserListList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("lists/memberships.json").toString(), new HttpParameter[] {
            new HttpParameter("cursor", l), new HttpParameter("count", i)
        }));
    }
    ...
    public PagableResponseList getUserListMemberships(long l)
        throws TwitterException
    {
        return getUserListMemberships(20, l);
    }

    public PagableResponseList getUserListMemberships(long l, int i, long l1)
        throws TwitterException
    {
        return getUserListMemberships(l, i, l1, false);
    }

    public PagableResponseList getUserListMemberships(long l, int i, long l1, boolean flag)
        throws TwitterException
    {
        return factory.createPagableUserListList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("lists/memberships.json").toString(), new HttpParameter[] {
            new HttpParameter("user_id", l), new HttpParameter("count", i), new HttpParameter("cursor", l1), new HttpParameter("filter_to_owned_lists", flag)
        }));
    }
    ...
    public PagableResponseList getUserListMemberships(long l, long l1, boolean flag)
        throws TwitterException
    {
        return getUserListMemberships(l, 20, l1, flag);
    }

    public PagableResponseList getUserListMemberships(String s, int i, long l)
        throws TwitterException
    {
        return getUserListMemberships(s, i, l, false);
    }

    public PagableResponseList getUserListMemberships(String s, int i, long l, boolean flag)
        throws TwitterException
    {
        return factory.createPagableUserListList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("lists/memberships.json").toString(), new HttpParameter[] {
            new HttpParameter("screen_name", s), new HttpParameter("count", i), new HttpParameter("cursor", l), new HttpParameter("filter_to_owned_lists", flag)
        }));
    }
    ...
    public PagableResponseList getUserListMemberships(String s, long l, boolean flag)
        throws TwitterException
    {
        return getUserListMemberships(s, 20, l, flag);
    }
    ...
    public PagableResponseList getUserListSubscribers(long l, int i, long l1)
        throws TwitterException
    {
        return getUserListSubscribers(l, i, l1, false);
    }

    public PagableResponseList getUserListSubscribers(long l, int i, long l1, boolean flag)
        throws TwitterException
    {
        return factory.createPagableUserList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("lists/subscribers.json").toString(), new HttpParameter[] {
            new HttpParameter("list_id", l), new HttpParameter("count", i), new HttpParameter("cursor", l1), new HttpParameter("skip_status", flag)
        }));
    }
    ...
    public PagableResponseList getUserListSubscribers(long l, long l1)
        throws TwitterException
    {
        return getUserListSubscribers(l, 20, l1, false);
    }

    public PagableResponseList getUserListSubscribers(long l, String s, int i, long l1)
        throws TwitterException
    {
        return getUserListSubscribers(l, s, i, l1, false);
    }

    public PagableResponseList getUserListSubscribers(long l, String s, int i, long l1, boolean flag)
        throws TwitterException
    {
        return factory.createPagableUserList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("lists/subscribers.json").toString(), new HttpParameter[] {
            new HttpParameter("owner_id", l), new HttpParameter("slug", s), new HttpParameter("count", i), new HttpParameter("cursor", l1), new HttpParameter("skip_status", flag)
    ...
    public PagableResponseList getUserListSubscribers(long l, String s, long l1)
        throws TwitterException
    {
        return getUserListSubscribers(l, s, 20, l1, false);
    }

    public PagableResponseList getUserListSubscribers(String s, String s1, int i, long l)
        throws TwitterException
    {
        return getUserListSubscribers(s, s1, i, l, false);
    }

    public PagableResponseList getUserListSubscribers(String s, String s1, int i, long l, boolean flag)
        throws TwitterException
    {
        return factory.createPagableUserList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("lists/subscribers.json").toString(), new HttpParameter[] {
            new HttpParameter("owner_screen_name", s), new HttpParameter("slug", s1), new HttpParameter("count", i), new HttpParameter("cursor", l), new HttpParameter("skip_status", flag)
    ...
    public PagableResponseList getUserListSubscribers(String s, String s1, long l)
        throws TwitterException
    {
        return getUserListSubscribers(s, s1, 20, l, false);
    }

    public PagableResponseList getUserListSubscriptions(long l, int i, long l1)
        throws TwitterException
    {
        return factory.createPagableUserListList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("lists/subscriptions.json").toString(), new HttpParameter[] {
            new HttpParameter("user_id", l), new HttpParameter("count", i), new HttpParameter("cursor", l1)
        }));
    }

    public PagableResponseList getUserListSubscriptions(long l, long l1)
        throws TwitterException
    {
        return getUserListSubscriptions(l, 20, l1);
    }

    public PagableResponseList getUserListSubscriptions(String s, int i, long l)
        throws TwitterException
    {
        return factory.createPagableUserListList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("lists/subscriptions.json").toString(), new HttpParameter[] {
    ...
    public PagableResponseList getUserListSubscriptions(String s, long l)
        throws TwitterException
    {
        return getUserListSubscriptions(s, 20, l);
    }

    public ResponseList getUserLists(long l)
        throws TwitterException
    {
        return getUserLists(l, false);
    }

    public ResponseList getUserLists(long l, boolean flag)
        throws TwitterException
    {
        return factory.createUserListList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("lists/list.json").toString(), new HttpParameter[] {
            new HttpParameter("user_id", l), new HttpParameter("reverse", flag)
        }));
    }
    ...
    public ResponseList getUserLists(String s)
        throws TwitterException
    {
        return getUserLists(s, false);
    }

    public ResponseList getUserLists(String s, boolean flag)
        throws TwitterException
    {
        return factory.createUserListList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("lists/list.json").toString(), new HttpParameter[] {
            new HttpParameter("screen_name", s), new HttpParameter("reverse", flag)
        }));
    }
    ...
    public PagableResponseList getUserListsOwnerships(long l, long l1)
        throws TwitterException
    {
        return getUserListsOwnerships(l, 20, l1);
    }
    ...
    public PagableResponseList getUserListsOwnerships(String s, long l)
        throws TwitterException
    {
        return getUserListsOwnerships(s, 20, l);
    }
    ...
    public transient ResponseList lookup(long al[])
        throws TwitterException
    {
    ...
    public transient ResponseList lookupFriendships(long al[])
        throws TwitterException
    {
    ...
    public transient ResponseList lookupFriendships(String as[])
        throws TwitterException
    {
    ...
    public transient ResponseList lookupUsers(long al[])
        throws TwitterException
    {
    ...
    public transient ResponseList lookupUsers(String as[])
        throws TwitterException
    {
        return factory.createUserList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("users/lookup.json").toString(), new HttpParameter[] {
    ...
    public User reportSpam(String s)
        throws TwitterException
    {
        return factory.createUser(post((new StringBuilder()).append(conf.getRestBaseURL()).append("users/report_spam.json").toString(), new HttpParameter[] {
            new HttpParameter("screen_name", s)
        }));
    }
        ...
        throws TwitterException
    {
        return factory.createDirectMessage(post((new StringBuilder()).append(conf.getRestBaseURL()).append("direct_messages/new.json").toString(), new HttpParameter[] {
            new HttpParameter("user_id", l), new HttpParameter("text", s), new HttpParameter("full_text", true)
        }));
    }
    ...
    {
        return factory.createDirectMessage(post((new StringBuilder()).append(conf.getRestBaseURL()).append("direct_messages/new.json").toString(), new HttpParameter[] {
            new HttpParameter("screen_name", s), new HttpParameter("text", s1), new HttpParameter("full_text", true)
        }));
    }
    ...
    public DirectMessage showDirectMessage(long l)
        throws TwitterException
    {
        return factory.createDirectMessage(get((new StringBuilder()).append(conf.getRestBaseURL()).append("direct_messages/show.json?id=").append(l).append("&full_text=true").toString()));
    }
    ...
    public SavedSearch showSavedSearch(long l)
        throws TwitterException
    {
        return factory.createSavedSearch(get((new StringBuilder()).append(conf.getRestBaseURL()).append("saved_searches/show/").append(l).append(".json").toString()));
    }
    ...
    public User showUser(String s)
        throws TwitterException
    {
        return factory.createUser(get((new StringBuilder()).append(conf.getRestBaseURL()).append("users/show.json").toString(), new HttpParameter[] {
            new HttpParameter("screen_name", s)
        }));
    }
    ...
    public UserList showUserList(String s, String s1)
        throws TwitterException
    {
        return factory.createAUserList(get((new StringBuilder()).append(conf.getRestBaseURL()).append("lists/show.json").toString(), new HttpParameter[] {
            new HttpParameter("owner_screen_name", s), new HttpParameter("slug", s1)
        }));
    }
    ...
    public User showUserListMembership(String s, String s1, long l)
        throws TwitterException
    {
        return factory.createUser(get((new StringBuilder()).append(conf.getRestBaseURL()).append("lists/members/show.json").toString(), new HttpParameter[] {
            new HttpParameter("owner_screen_name", s), new HttpParameter("slug", s1), new HttpParameter("user_id", l)
        }));
    }
    ...
    public User showUserListSubscription(String s, String s1, long l)
        throws TwitterException
    {
        return factory.createUser(get((new StringBuilder()).append(conf.getRestBaseURL()).append("lists/subscribers/show.json").toString(), new HttpParameter[] {
            new HttpParameter("owner_screen_name", s), new HttpParameter("slug", s1), new HttpParameter("user_id", l)
        }));
    }
    ...
    public User verifyCredentials()
        throws TwitterException
    {
        return super.fillInIDAndScreenName(new HttpParameter[] {
            new HttpParameter("include_email", conf.isIncludeEmailEnabled())
        });
    }
    ...
    private static final long serialVersionUID = 0x2edf5f0aL;
