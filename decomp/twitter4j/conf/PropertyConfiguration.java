    ...
    implements Serializable
{
    ...
    private boolean getBoolean(Properties properties, String s, String s1)
    {
        return Boolean.valueOf(properties.getProperty((new StringBuilder()).append(s).append(s1).toString())).booleanValue();
    }

    private int getIntProperty(Properties properties, String s, String s1)
    {
    ...
    private long getLongProperty(Properties properties, String s, String s1)
    {
        properties = properties.getProperty((new StringBuilder()).append(s).append(s1).toString());
        long l;
        try
    ...
    private String getString(Properties properties, String s, String s1)
    {
...
_L3:
    ...
    private void setFieldsWithPrefix(Properties properties, String s)
    {
        ...
        do
        {
            ...
            if(notNull(properties, s, "streamThreadName"))
                setStreamThreadName(getString(properties, s, "streamThreadName"));
            ...
            if(notNull(properties, s, "includeEmail"))
                setIncludeEmailEnabled(getBoolean(properties, s, "includeEmail"));
            if(notNull(properties, s, "includeExtAltText"))
                setIncludeExtAltTextEnabled(getBoolean(properties, s, "includeExtAltText"));
            if(notNull(properties, s, "tweetModeExtended"))
                setTweetModeExtended(getBoolean(properties, s, "tweetModeExtended"));
    ...
    public volatile String getStreamThreadName()
    {
    ...
    public volatile boolean isIncludeEmailEnabled()
    {
    ...
    public volatile boolean isIncludeExtAltTextEnabled()
    {
    ...
    public volatile boolean isTweetModeExtended()
    {
    ...
    public volatile void setIncludeExtAltTextEnabled(boolean flag)
    {
        super.setIncludeExtAltTextEnabled(flag);
    }
    ...
    public volatile void setTweetModeExtended(boolean flag)
    {
        super.setTweetModeExtended(flag);
    }
    ...
    private static final long serialVersionUID = 0x372c393cL;
}
