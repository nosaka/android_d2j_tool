...
public final class ConfigurationBuilder
{
    ...
    public ConfigurationBuilder setIncludeEmailEnabled(boolean flag)
    {
        checkNotBuilt();
        configurationBean.setIncludeEmailEnabled(flag);
        return this;
    }
    ...
    public ConfigurationBuilder setIncludeExtAltTextEnabled(boolean flag)
    {
        checkNotBuilt();
        configurationBean.setIncludeExtAltTextEnabled(flag);
        return this;
    }
    ...
    public ConfigurationBuilder setTweetModeExtended(boolean flag)
    {
        checkNotBuilt();
        configurationBean.setTweetModeExtended(flag);
        return this;
    }
