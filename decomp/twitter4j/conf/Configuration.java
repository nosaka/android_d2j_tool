...
public interface Configuration
    extends AuthorizationConfiguration, Serializable
{
    ...
    public abstract String getStreamThreadName();
    ...
    public abstract boolean isIncludeEmailEnabled();

    public abstract boolean isIncludeEntitiesEnabled();

    public abstract boolean isIncludeExtAltTextEnabled();
    ...
    public abstract boolean isTweetModeExtended();
