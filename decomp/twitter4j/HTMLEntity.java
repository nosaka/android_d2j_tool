            ...
            if(i < s.length())
            {
                ...
                if(j < aentityindex.length)
                    if(k != 0)
                    {
                        i1 = j;
                        i = k;
                        if(aentityindex[j].getStart() == j1 + l)
                        {
