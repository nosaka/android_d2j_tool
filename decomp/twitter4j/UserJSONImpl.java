...
label0:
        ...
        throws TwitterException
    {
        ...
        email = ParseUtil.getRawString("email", jsonobject);
        ...
        URLEntity aurlentity[] = getURLEntitiesFromJSON(jsonobject, "url");
        ...
        jsonarray = jsonobject.getJSONArray("withheld_in_countries");
        j = jsonarray.length();
        ...
        while(i < j) 
        {
            try
            {
                withheldInCountries[i] = jsonarray.getString(i);
            }
