...
_L1:
    ...
    {
        return (int)(id - savedsearch.getId());
    }
    ...
    public int hashCode()
    {
        return (((createdAt.hashCode() * 31 + query.hashCode()) * 31 + position) * 31 + name.hashCode()) * 31 + (int)id;
    }
    ...
    private static final long serialVersionUID = 0xf6e88d64L;
