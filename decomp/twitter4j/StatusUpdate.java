...
_L4:
        appendParameter("attachment_url", attachmentUrl, arraylist);
...
_L3:
    ...
    public StatusUpdate attachmentUrl(String s)
    {
        setAttachmentUrl(s);
        return this;
    }
    ...
    public void setAttachmentUrl(String s)
    {
        attachmentUrl = s;
    }
    ...
    public transient void setMediaIds(long al[])
    {
        mediaIds = al;
    }
    ...
    private static final long serialVersionUID = 0x87091b13L;
