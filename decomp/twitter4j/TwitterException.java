...
//            TwitterResponse, HttpResponseCode, HttpResponse, JSONException, 
    ...
    implements TwitterResponse, HttpResponseCode
{
    ...
    private void decode(String s)
    {
        ...
        if(!s.isNull("errors"))
        {
            ...
            errorCode = ParseUtil.getInt("code", s);
        }
        return;
        s;
    }
...
_L5:
    ...
    public int hashCode()
    {
        ...
        if(nested)
            l = 1;
        return ((((i1 * 31 + j1) * 31 + i) * 31 + j) * 31 + k) * 31 + l;
    }
    ...
    public String toString()
    {
        ...
        if(nested)
            ...
            s = (new StringBuilder()).append("exceptionCode=[").append(getExceptionCode()).append("], ").toString();
    ...
    private static final long serialVersionUID = 0x220f22b8L;
