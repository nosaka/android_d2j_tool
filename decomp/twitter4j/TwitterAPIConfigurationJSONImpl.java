    ...
    implements TwitterAPIConfiguration
{
        ...
        throws TwitterException
    {
        ...
        dmTextCharacterLimit = ParseUtil.getInt("dm_text_character_limit", jsonobject1);
...
_L1:
    ...
    public boolean equals(Object obj)
    {
        if(this != obj)
        {
            ...
            if(charactersReservedPerMedia != ((TwitterAPIConfigurationJSONImpl) (obj)).charactersReservedPerMedia)
                return false;
            if(dmTextCharacterLimit != ((TwitterAPIConfigurationJSONImpl) (obj)).dmTextCharacterLimit)
                return false;
    ...
    public int hashCode()
    {
        ...
        return ((((((k * 31 + l) * 31 + i1) * 31 + j1) * 32 + k1) * 31 + i) * 31 + j) * 31 + maxMediaPerUpload;
    }

    public String toString()
    {
        StringBuilder stringbuilder = (new StringBuilder()).append("TwitterAPIConfigurationJSONImpl{photoSizeLimit=").append(photoSizeLimit).append(", shortURLLength=").append(shortURLLength).append(", shortURLLengthHttps=").append(shortURLLengthHttps).append(", charactersReservedPerMedia=").append(charactersReservedPerMedia).append(", dmTextCharacterLimit=").append(dmTextCharacterLimit).append(", photoSizes=").append(photoSizes).append(", nonUsernamePaths=");
        java.util.List list;
        if(nonUsernamePaths == null)
            list = null;
        else
    ...
    private static final long serialVersionUID = 0x6c4562baL;
