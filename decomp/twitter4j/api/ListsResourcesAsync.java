...
public interface ListsResourcesAsync
{
    ...
    public transient abstract void createUserListMembers(long l, String s, long al[]);

    public transient abstract void createUserListMembers(long l, String s, String as[]);

    public transient abstract void createUserListMembers(long l, long al[]);

    public transient abstract void createUserListMembers(long l, String as[]);
