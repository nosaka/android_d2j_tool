...
public class ConversationActivity extends ViewPagerActivity
{
    ...
    protected void onCreate(Bundle bundle)
    {
        ...
        bundle.putInt("activity", EnumViewPagerFragment.CONVERSATION.ordinal());
        ViewPagerFragment viewpagerfragment = new ViewPagerFragment();
        viewpagerfragment.setArguments(bundle);
        setFragment(viewpagerfragment, "conversationFragment", 0x7f0e0085);
    }
}
