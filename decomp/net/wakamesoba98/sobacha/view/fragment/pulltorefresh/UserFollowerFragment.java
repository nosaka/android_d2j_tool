...
public class UserFollowerFragment extends CursorPullToRefreshFragment
{
    ...
    protected void initTimeLine()
    {
        ...
        {
            showRefreshing();
            (new UserPageApi(getActivity(), adapter, userAccount)).getFollowers(this, targetUserId, 0);
        }
    }
    ...
    public void onActivityCreated(Bundle bundle)
    {
        ...
        adapter = ((AdapterHolder)getParentFragment()).getAdapter(EnumTab.FOLLOWERS);
    ...
    public void pullToRefresh(EnumPullDirection enumpulldirection)
    {
        if(enumpulldirection == EnumPullDirection.UP)
            (new UserPageApi(getActivity(), adapter, userAccount)).getFollowers(this, targetUserId, cursor, 0);
    }
