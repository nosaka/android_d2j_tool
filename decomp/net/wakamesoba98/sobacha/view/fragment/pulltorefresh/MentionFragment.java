...
public class MentionFragment extends PullToRefreshFragment
{
    ...
    protected void initTimeLine()
    {
        if(adapter.getCount() == 0 && hasNext() && !isRefreshing())
        {
            ...
            showRefreshing();
            timelineapi.getMentions(this, paging, 0);
        }
    }
    ...
    public void onActivityCreated(Bundle bundle)
    {
        ...
        adapter = ((AdapterHolder)getActivity()).getAdapter(EnumTab.MENTION);
