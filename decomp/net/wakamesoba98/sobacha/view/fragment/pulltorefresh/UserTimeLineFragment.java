...
public class UserTimeLineFragment extends PullToRefreshFragment
{
    ...
    protected void initTimeLine()
    {
        if(adapter.getCount() == 0 && hasNext() && !isRefreshing())
        {
            ...
            timelineapi.getUserTimeLine(this, targetUserId, paging, 0);
        }
    }
    ...
    public void onActivityCreated(Bundle bundle)
    {
        ...
        adapter = ((AdapterHolder)getParentFragment()).getAdapter(EnumTab.USER_TIMELINE);
