...
//            RemoteInput, NotificationCompatApi20, NotificationCompatKitKat, NotificationCompatBase, 
//            NotificationCompatApi21, NotificationCompatHoneycomb
...
public class NotificationCompat
{
    public static class Action extends NotificationCompatBase.Action
    {
        ...
        public static final NotificationCompatBase.Action.Factory FACTORY = new NotificationCompatBase.Action.Factory() {
            ...
            public NotificationCompatBase.Action build(int i, CharSequence charsequence, PendingIntent pendingintent, Bundle bundle, RemoteInputCompatBase.RemoteInput aremoteinput[], boolean flag)
            {
                return new Action(i, charsequence, pendingintent, bundle, (RemoteInput[])(RemoteInput[])aremoteinput, flag);
            }
...
;
        ...
        Action(int i, CharSequence charsequence, PendingIntent pendingintent, Bundle bundle, RemoteInput aremoteinput[], boolean flag)
        {
            icon = i;
    ...
    public static final class Action.Builder
    {
        ...
        public Action build()
        {
            ...
            if(mRemoteInputs != null)
                ...
                aremoteinput = null;
            return new Action(mIcon, mTitle, mIntent, mExtras, aremoteinput, mAllowGeneratedReplies);
        }
