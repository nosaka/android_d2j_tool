...
//            PointerIconCompat, ViewCompatApi24, ViewCompatMarshmallow, ViewCompatLollipop, 
//            ViewCompatKitKat, ViewCompatJB, ViewCompatJellybeanMr2, ViewCompatJellybeanMr1, 
//            ViewCompatICSMr1, ViewCompatICS, ViewCompatHC, ScrollingView, 
//            NestedScrollingChild, ViewCompatBase
...
public class ViewCompat
{
    static class Api24ViewCompatImpl extends MarshmallowViewCompatImpl
    {
        ...
        public void setPointerIcon(View view, PointerIconCompat pointericoncompat)
        {
            ...
            ViewCompatApi24.setPointerIcon(view, pointericoncompat);
        }
...
_L5:
    ...
    static class LollipopViewCompatImpl extends KitKatViewCompatImpl
    {
        ...
        public void setOnApplyWindowInsetsListener(View view, OnApplyWindowInsetsListener onapplywindowinsetslistener)
        {
            ...
            {
                ViewCompatLollipop.setOnApplyWindowInsetsListener(view, onapplywindowinsetslistener. new ViewCompatLollipop.OnApplyWindowInsetsListenerBridge() {

                    public Object onApplyWindowInsets(View view, Object obj)
                    {
                        obj = WindowInsetsCompat.wrap(obj);
                        return WindowInsetsCompat.unwrap(listener.onApplyWindowInsets(view, ((WindowInsetsCompat) (obj))));
                    }

                    final LollipopViewCompatImpl this$0;
                    final OnApplyWindowInsetsListener val$listener;

            
            {
                this$0 = final_lollipopviewcompatimpl;
    ...
    static interface ViewCompatImpl
    {
        ...
        public abstract Matrix getMatrix(View view);
        ...
        public abstract int getScrollIndicators(View view);
        ...
        public abstract boolean hasOnClickListeners(View view);
        ...
        public abstract boolean isInLayout(View view);

        public abstract boolean isLaidOut(View view);

        public abstract boolean isLayoutDirectionResolved(View view);
        ...
        public abstract void setPointerIcon(View view, PointerIconCompat pointericoncompat);
        ...
        public abstract void setScrollIndicators(View view, int i);

        public abstract void setScrollIndicators(View view, int i, int j);
        ...
        public abstract void setZ(View view, float f);
