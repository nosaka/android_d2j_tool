...
class MediaControllerCompatApi21
{
    ...
    static class CallbackProxy extends android.media.session.MediaController.Callback
    {
        ...
        {
            mCallback.onAudioInfoChanged(playbackinfo.getPlaybackType(), PlaybackInfo.getLegacyAudioStream(playbackinfo), playbackinfo.getVolumeControl(), playbackinfo.getMaxVolume(), playbackinfo.getCurrentVolume());
        }
